...
<main class="mdl-layout__content">
  <div class="bContent" style="text-align:left;">   
    <h2 style="text-align: center; font-size: 80px; line-height: 1.3;">IEEE Floating Point</h2>
    <hr />
    <div class="mdl-grid">
      <div class="mdl-cell mdl-cell--4-col">
        <div class="mdl-card mdl-shadow--2dp" style="width: 100%;">
          <div class="mdl-card__title">
            ...
            <h2 class="mdl-card__title-text">Assignment 2</h2>
            <!-- InstanceEndEditable -->
          </div>
          <div class="mdl-card__supporting-text">
            <!-- InstanceBeginEditable name="assignDDate" -->
            <h5>Due Date: 06/05/15</h5>
            <!-- InstanceEndEditable -->
          ...
          <div class="mdl-card__actions mdl-card--border">
            <a href="3332_01_02_HW.php" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--accent">
              Go to Page
            </a>
          </div>
        </div>
      ...
      <div class="mdl-cell mdl-cell--4-col">
        <div class="mdl-card mdl-shadow--2dp" style="width: 100%;">
          <div class="mdl-card__title">
            ...
            <h2 class="mdl-card__title-text">Practice Quiz 2</h2>
            <!-- InstanceEndEditable -->
          </div>
          <div class="mdl-card__supporting-text">
            <!-- InstanceBeginEditable name="pQuizDDate" -->
            <h5>Due Date: 06/06/15</h5>
            <!-- InstanceEndEditable -->
          ...
          <div class="mdl-card__actions mdl-card--border">
            <a href="3332_01_02_QIntro.php" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--accent">
              Go to Page
            </a>
          </div>
        </div>
      ...
      <div class="mdl-cell mdl-cell--4-col">
        <div class="mdl-card mdl-shadow--2dp" style="width: 100%;">
          <div class="mdl-card__title">
            ...
            <h2 class="mdl-card__title-text">Quiz 2</h2>
            <!-- InstanceEndEditable -->
          </div>
          <div class="mdl-card__supporting-text">
            <!-- InstanceBeginEditable name="quizDDate" -->
            <h5>Due Date: 06/07/15</h5>
            <!-- InstanceEndEditable -->
