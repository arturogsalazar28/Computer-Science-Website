...
<main class="mdl-layout__content">
    <div class="bContent" style="text-align:left;"> 
        <h2 style="text-align: center; font-size: 80px; line-height: 1.3;">Assignment 1</h2>
        <hr>
      ...
      <div class="uploadForm">
        ...
        <form enctype="multipart/form-data" method="post" action="">
          ...
          <a name="returnToPage" href="3332_NumSys_BinHexOc.php" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Return to Topic</a> 
        </form> 
      </div>
      <?php
